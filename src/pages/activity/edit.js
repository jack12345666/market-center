...
import { Button, Form, Select, DatePicker, Row, Col, Input, Radio, Divider, InputNumber, Tooltip, message, Tag } from 'antd'
        ...
        <div>
              <div className={Style.box}>
                  <div className={Style.editTop}>
                    <div>
                        <img alt="tag" className={Style.tag} src={require('../../assets/tag.png')}/>
                        <div className={Style.tagName}>编辑活动</div>
                    </div>
                    {status == '0' && <div className={Style.tips}><Tag color="#f50">活动待审核过程中无法修改</Tag></div>} 
                  ...
                  <Col span={11}>
                    ...
                    <Select disabled={status == '0' ? true : false} onChange={this.changeCompany} placeholder="请选择企业" style={{marginLeft: '10px'}}>
                        {companyOptions}
                    </Select>
                    </Form.Item> 
                  </Col>
                  ...
                  <Col span={24}>
                    <Form.Item {...layout} name="comment" label="活动说明"  rules={[{required: true, message: '请填写活动地址'}]}>
                      <TextArea disabled={status == '0' ? true : false} placeholder={activityType === 1 ? '请填写线上活动地址' : '请填写线下活动地址'} autoSize={{minRows: 2, maxRows: 3 }}/>
                    </Form.Item>
                  </Col> 
                  <Col span={11}>
                  ...
                  <Col span={24}>
                    ...
                    <Radio.Group  disabled={status == '0' ? true : false} value={null}>
