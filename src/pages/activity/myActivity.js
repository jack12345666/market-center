...
import EnrollDetail from '../components/entrollDetail/index'
import { ACTIVITYURL } from '@/utils/config'
...
class MyActivity extends Component {
    ...
    onActivityDetail = record => {
      window.open(`${ACTIVITYURL}/${record.id}`,"_blank")       
    }
    ...
    render() {
        ...
        const { showDetail, enrollId } = this.state
