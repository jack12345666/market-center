            ...
            <div className={Style.box}>
                <div className={Style.top}>
                    <div className={Style.img}>
                        <img alt="default" style={{width: '500px', height: '280px'}} src={data.poster}/>
                    </div>
                ...
                <div className={Style.bottom}> 
                 <Card>
                    ...
                    <div className={Style.root}>{data.contact}</div>
                        {/* <div className={Style.time}>刚刚</div> */}
                    </div>
                 {data.description ? <div className={Style.detailContent} dangerouslySetInnerHTML={{__html: data.description}} ></div> : 
                  <Empty
                        style={{margin: '20px 0'}}
